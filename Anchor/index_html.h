...
data-highlights="0 30#00f 30 50#0f0 50 100#f00"
data-onready="setInterval(aktualisieren,500);"
></canvas><br>

<div style="text-align:center"
<form>
<input type="button" class="button down" value="⇩ Down" onclick="key('down')"> 
<input type="button" class="button stop" value="⬛ Stop" onclick="key('stop')"> 
<input type="button" class="button up" value="⇧ Up" onclick="key('up')"> 
<p> </p>
<input type="button" class="button reset" value="↻ Reset" onclick="key('reset')">
</form>
</div>
</div>
</div>
